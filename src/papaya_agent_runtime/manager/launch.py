...
_ROLE = (
    ...
    "works the same, do not start a sign-in or wait for one, and do not repeat the "
    "one-line invitation already printed at launch (connect only if the user asks). "
    "Then `ppy repo list`, and `ppy repo discover` when nothing is registered, so "
