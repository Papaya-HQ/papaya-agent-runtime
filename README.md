...
the round early. Each sweep writes one line on stderr: `sweep found N, offered M,
skipped K`. Set the cadence with `--sweep-interval SECONDS` or `PPY_SWEEP_INTERVAL`
