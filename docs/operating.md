...
The long-form reference for Papaya Agent Runtime: how it behaves once it is running,
what it does on its own authority, where its state lives, and how to keep it running on
a machine without the Papaya app. [`README.md`](../README.md) is the short version and
the way in; [`runtime-contract.md`](runtime-contract.md) is the contract a session
follows.
...
ppy papaya connect --create-engineer    # sign in and pin this machine to your engineering agent, creating it if you have none
