...
| Capability | claude 2.1.282 | codex 0.150.1 |
| --- | --- | --- |
...
- Model: `haiku`
- Probed at: 2026-09-25T15:07:03.338964+00:00
- Probe harness: 0.1.47.post1+gf3584a0

| Scenario | Status | Detail |
| --- | --- | --- |
| clean_complete | proved | clean run exited 0 with session id 07e9ddd7-7b15-4c05-ac24-c06bab5a0704 |
...
| sigint_model_turn | proved | base exit=0 dur=5.3s interrupt_at_line=10; resumed after SIGINT (resume exit 0) |
| sigint_tool | proved | base exit=0 dur=6.4s; interrupted=True; orphan_sleep=False; worktree_dirty=False; resume exit 0 |
| sigkill_survival | proved | base exit=-9 dur=4.3s interrupt_at_line=10; resumed after SIGKILL (resume exit 0) |
